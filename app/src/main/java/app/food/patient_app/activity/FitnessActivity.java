...
public class FitnessActivity extends AppCompatActivity
{
                            ...
                            public void onConnectionFailed(ConnectionResult result) {
                              ...
                              /*  if (!authInProgress) {
                                    try {
                                        ...
                                        authInProgress = true;
                                        result.startResolutionForResult(FitnessActivity.this, REQUEST_OAUTH);
    ...
    private boolean hasOAuthPermission() {
        ...
        return GoogleSignIn.hasPermissions(GoogleSignIn.getLastSignedInAccount(getApplicationContext()), fitnessOptions);
    }
