...
public class AppService extends Service {
    ...
    private Runnable mRepeatCheckTask = new Runnable() {
        ...
        public void run() {
            if (!mManager.hasPermission(mContext)) {
                ...
                Toast.makeText(mContext, app.food.patient_app.R.string.grant_success, Toast.LENGTH_SHORT).show();
    ...
    private void startIntervalCheck() {
        ...
        if (valid) {
            Toast.makeText(mContext, app.food.patient_app.R.string.toast_permission, Toast.LENGTH_LONG).show();
            mHandler.post(mRepeatCheckTask);
        } else {
            Toast.makeText(mContext, app.food.patient_app.R.string.not_support, Toast.LENGTH_LONG).show();
        }
    }
